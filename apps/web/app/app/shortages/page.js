  ...
  return (
    <Box>
      <Box sx={{ mb: 2, borderRadius: 3, bgcolor: "rgba(79,70,229,0.08)", px: 2, py: 1.5, fontSize: 14, color: "#4338ca" }}>
        Per-driver shortage cuts from the <b>Statement Of Freight</b>. Depot shortages often arrive 15–45 days late — each one is tracked here as <b>Pending</b> (not yet cut from salary) or <b>Deducted</b> (and which month&apos;s payslip it was cut in).
      </Box>
